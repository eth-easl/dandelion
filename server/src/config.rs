...
const DEFAULT_MAX_RETRY_TIMES: usize = 1;
const DEFAULT_PER_RETRY_TIMEOUT_MILLISECONDS: u64 = 250; // any value works for MAX_RETRY_TIMES=1
...
pub struct DandelionConfig {
    ...
    #[arg(long, env, default_value_t = String::from(DEFAULT_RATE_LIMITING_REDIS_PASS))]
    #[serde(default)]
    pub rate_limiting_redis_pass: String,
